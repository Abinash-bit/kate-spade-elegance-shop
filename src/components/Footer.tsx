...
const Footer = () => {
  ...
  return (
    <footer className="bg-katespade-black text-white">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div className="col-span-1">
            <h3 className="text-xl font-bold mb-4">kate spade</h3>
            <p className="text-gray-400 mb-4">
              Crisp color, graphic prints and playful sophistication are the hallmarks of kate spade new york.
            </p>
          ...
          <div className="col-span-1">
            ...
            <form className="flex">
              ...
              <button
                type="submit"
                className="bg-katespade-pink px-4 py-2 text-white hover:bg-opacity-90"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-gray-400 text-sm">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p>&copy; {currentYear} kate spade new york. All rights reserved.</p>
